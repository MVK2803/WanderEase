    ...
    return(
       <div className="min-h-full w-full absolute flex flex-col items-center justify-center bg-black" id="landing-bg">
        <div className=" text-center space-y-4 w-1/2">
            <h className="text-6xl text-white font-extrabold">WanderEase<span className="text-lime-500">.</span></h>
            <h2 className=" text-2xl text-gray-500">"Let us take you there: your all-in-one travel planning solution."</h2>
